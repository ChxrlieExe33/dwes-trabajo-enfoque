...
<body>
    ...
    <form class="w-full px-[25%] py-6 flex flex-col items-center justify-start gap-4 pb-12" method="post">

        <h1 class="text-2xl font-bold">Datos personales</h1>

        <p><b>Correo:</b> <?php echo $userData->getEmail(); ?></p>

        <section class="px-20 w-full flex flex-col items-start justify-items-start">
        ...
        <section class="px-20 w-full flex flex-col items-center justify-items-start">
